...
export default function FechaNacimientoEditable({ initialValue, campoEnEdicion, setCampoEnEdicion, setFechaVisual }: Props) {
  ...
  const handleGuardar = async () => {
    ...
    try {
      setLoading(true);
      await updateUserField('fecha_nacimiento', valorTemporal);
